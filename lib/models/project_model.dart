...
extension ProjectStageX on ProjectStage {
  String get label {
    switch (this) {
      ...
      case ProjectStage.foundationPlinthWork: return 'Foundation & Plinth Work';
      case ProjectStage.floorConstruction:    return 'Floor Construction';
      case ProjectStage.finishingWork:        return 'Finishing Work';
      case ProjectStage.externalWorks:        return 'External Works';
      case ProjectStage.materialMaster:       return 'Material Master';
      case ProjectStage.labourMaster:         return 'Labour Master';
      case ProjectStage.equipmentMaster:      return 'Equipment Master';
    }
  }
}
...
class ProjectModel {
  ...
  factory ProjectModel.fromJson(Map<String, dynamic> j) => ProjectModel(
        ...
        expectedEndDate: j['expectedEndDate'] != null
                           ? DateTime.tryParse(j['expectedEndDate'] as String) : null,
...
class EntryModel {
  ...
  static List<EntryModel> decodeList(String raw) {
    final List<dynamic> decoded = jsonDecode(raw) as List<dynamic>;
    return decoded.map((e) => EntryModel.fromJson(e as Map<String, dynamic>)).toList();
  }
}
