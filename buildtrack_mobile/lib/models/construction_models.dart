...
List<ConstructionPhase> buildDefaultPhases() => [
      ...
      ConstructionPhase(name: 'Foundation & Plinth Work', activities: [
        ...
        _a('Foundation & Plinth Work', 'General', 'Vertical Alignment Check (Plumb Bob)'),
        _a('Foundation & Plinth Work', 'General', 'Cover Block Placement - Column'),
        _a('Foundation & Plinth Work', 'General', 'Concrete Pouring - Column'),
        _a('Foundation & Plinth Work', 'General', 'Concrete Vibration - Column'),
        _a('Foundation & Plinth Work', 'General', 'Column Casting up to Plinth Beam Level'),
        _a('Foundation & Plinth Work', 'General', 'Deshuttering - Column'),
        _a('Foundation & Plinth Work', 'General', 'Curing - Column'),
        _a('Foundation & Plinth Work', 'General', 'Soil Backfilling up to Ground Level'),
        _a('Foundation & Plinth Work', 'General', 'Watering & Compaction - Soil'),
        _a('Foundation & Plinth Work', 'General', 'PCC Preparation - Plinth Beam'),
        _a('Foundation & Plinth Work', 'General', 'Reinforcement - Plinth Beam'),
        _a('Foundation & Plinth Work', 'General', 'Shuttering - Plinth Beam'),
        _a('Foundation & Plinth Work', 'General', 'Concrete Pouring - Plinth Beam'),
        _a('Foundation & Plinth Work', 'General', 'Concrete Vibration - Plinth Beam'),
        _a('Foundation & Plinth Work', 'General', 'Deshuttering - Plinth Beam'),
        _a('Foundation & Plinth Work', 'General', 'Soil Backfilling up to Plinth Level'),
        _a('Foundation & Plinth Work', 'General', 'Compaction using Earth Rammer'),
      ]),

      // ── 4. FLOOR CONSTRUCTION ─────────────────────────────────────────────
      ConstructionPhase(name: 'Floor Construction', activities: [
        ...
        _a('Floor Construction', 'General', 'Vertical Alignment Check (Plumb Bob)'),
      ...
      // ── 5. FINISHING WORK ─────────────────────────────────────────────────
      ConstructionPhase(name: 'Finishing Work', activities: [
      ...
      // ── 6. EXTERNAL WORKS ─────────────────────────────────────────────────
      ConstructionPhase(name: 'External Works', activities: [
      ...
      // ── 7. MATERIAL MASTER ────────────────────────────────────────────────
      ConstructionPhase(name: 'Material Master', activities: [
      ...
      // ── 8. LABOUR MASTER ──────────────────────────────────────────────────
      ConstructionPhase(name: 'Labour Master', activities: [
      ...
      // ── 9. EQUIPMENT MASTER ───────────────────────────────────────────────
      ConstructionPhase(name: 'Equipment Master', activities: [
